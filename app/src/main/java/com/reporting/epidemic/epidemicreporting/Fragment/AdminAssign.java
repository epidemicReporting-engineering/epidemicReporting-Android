 ...
 */
public class AdminAssign extends Fragment implements IAssignTaskView, LocationSource, AMapLocationListener,AMap.OnMarkerClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View admin = inflater.inflate(R.layout.fragment_admin, container, false);
        ButterKnife.bind(this, admin);
...
//                    showSureOrCancleDialog(getActivity(), user.getName(), user.getUsername(),user.getLocation());
//                    break;
//                }
//            }
//        }
